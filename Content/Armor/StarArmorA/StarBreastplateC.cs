...
namespace ExpansionKele.Content.Armor.StarArmorA
{
	...
	public class StarBreastplateC : ModItem
	{
		...
		public static string setNameOverride="星元甲C";
    ...
    Recipe recipe = Recipe.Create(ModContent.ItemType<StarBreastplateC>()); // 替换为 GaSniperA 的类型  
    recipe.AddIngredient(ItemID.HellstoneBar, 12);
	recipe.AddIngredient(ItemID.Bone, 6);
	recipe.AddIngredient(ModContent.ItemType<StarBreastplateB>(), 1); 
