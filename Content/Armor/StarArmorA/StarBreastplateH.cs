...
namespace ExpansionKele.Content.Armor.StarArmorA
{
	...
	public class StarBreastplateH : ModItem
	{
		...
		public static string setNameOverride="星元甲H";
    ...
    Recipe recipe = Recipe.Create(ModContent.ItemType<StarBreastplateH>()); // 替换为 GaSniperA 的类型  
    recipe.AddIngredient(ItemID.BeetleHusk, 8);//
    recipe.AddIngredient(ModContent.ItemType<StarBreastplateG>(), 1);
