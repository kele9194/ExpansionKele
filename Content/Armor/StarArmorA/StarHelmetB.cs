...
namespace ExpansionKele.Content.Armor.StarArmorA
{
	...
	public class StarHelmetB : ModItem
	{
    	...
    	return head.type == ModContent.ItemType<StarHelmetB>() &&
           body.type == ModContent.ItemType<StarBreastplateB>() &&
           legs.type == ModContent.ItemType<StarLeggingsB>();
}
