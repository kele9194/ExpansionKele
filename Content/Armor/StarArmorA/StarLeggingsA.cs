...
namespace ExpansionKele.Content.Armor.StarArmorA
{
	...
	public class StarLeggingsA : ModItem
	{
		...
		public static string setNameOverride="星元护胫A";
...
// ... existing code ...
    ...
    Recipe recipe = Recipe.Create(ModContent.ItemType<StarLeggingsA>()); // 替换为 GaSniperA 的类型  
    recipe.AddRecipeGroup("ExpansionKele:BeforeSecondaryBars", 18); // 添加任意金锭组，要求7个  
