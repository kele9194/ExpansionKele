...
namespace ExpansionKele.Content.Armor.StarArmorA
{
	...
	public class StarLeggingsB : ModItem
	{
		...
		public static string setNameOverride="星元护胫B";
...
// ... existing code ...
    ...
    Recipe recipe = Recipe.Create(ModContent.ItemType<StarLeggingsB>()); // 替换为 GaSniperA 的类型  
    recipe.AddRecipeGroup("ExpansionKele:AnyDemoniteBar", 9); // 添加任意魔锭组，要求7个
	recipe.AddRecipeGroup("ExpansionKele:AnyShadowScale", 3);//添加任意暗影文化组，要求7个
    recipe.AddIngredient(ModContent.ItemType<StarLeggingsA>(), 1); 
