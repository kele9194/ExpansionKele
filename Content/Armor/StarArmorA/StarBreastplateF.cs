...
namespace ExpansionKele.Content.Armor.StarArmorA
{
	...
	public class StarBreastplateF : ModItem
	{
		...
		public static string setNameOverride="星元甲F";
    ...
    Recipe recipe = Recipe.Create(ModContent.ItemType<StarBreastplateF>()); // 替换为 GaSniperA 的类型  
     recipe.AddRecipeGroup("ExpansionKele:TertiaryBars", 12); // 添加任意金锭组，要求7个  
	 recipe.AddIngredient(ItemID.SoulofSight,1);
    recipe.AddIngredient(ModContent.ItemType<StarBreastplateE>(), 1);
