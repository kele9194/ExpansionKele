...
namespace ExpansionKele.Content.Armor.StarArmorA
{
	...
	public class StarHelmetE : ModItem
	{
    	...
    	return head.type == ModContent.ItemType<StarHelmetE>() &&
           body.type == ModContent.ItemType<StarBreastplateE>() &&
           legs.type == ModContent.ItemType<StarLeggingsE>();
}
