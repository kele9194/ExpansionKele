...
namespace ExpansionKele.Content.Armor.StarArmorA
{
	...
	public class StarHelmetF : ModItem
	{
    	...
    	return head.type == ModContent.ItemType<StarHelmetF>() &&
           body.type == ModContent.ItemType<StarBreastplateF>() &&
           legs.type == ModContent.ItemType<StarLeggingsF>();
}
