...
namespace ExpansionKele.Content.Armor.StarArmorA
{
	...
	public class StarLeggingsH : ModItem
	{
		...
		public static string setNameOverride="星元护胫H";
    ...
    Recipe recipe = Recipe.Create(ModContent.ItemType<StarLeggingsH>()); // 替换为 GaSniperA 的类型  
    recipe.AddIngredient(ItemID.BeetleHusk, 6);//
    recipe.AddIngredient(ModContent.ItemType<StarLeggingsG>(), 1);
