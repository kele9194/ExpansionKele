...
namespace ExpansionKele.Content.Armor.StarArmorA
{
	...
	public class StarHelmetD : ModItem
	{
    	...
    	return head.type == ModContent.ItemType<StarHelmetD>() &&
           body.type == ModContent.ItemType<StarBreastplateD>() &&
           legs.type == ModContent.ItemType<StarLeggingsD>();
}
