...
namespace ExpansionKele.Content.Armor.StarArmorA
{
	...
	public class StarHelmetH : ModItem
	{
    	...
    	return head.type == ModContent.ItemType<StarHelmetH>() &&
           body.type == ModContent.ItemType<StarBreastplateH>() &&
           legs.type == ModContent.ItemType<StarLeggingsH>();
}
