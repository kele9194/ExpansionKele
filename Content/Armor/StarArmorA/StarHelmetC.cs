...
namespace ExpansionKele.Content.Armor.StarArmorA
{
	...
	public class StarHelmetC : ModItem
	{
    	...
    	return head.type == ModContent.ItemType<StarHelmetC>() &&
           body.type == ModContent.ItemType<StarBreastplateC>() &&
           legs.type == ModContent.ItemType<StarLeggingsC>();
}
