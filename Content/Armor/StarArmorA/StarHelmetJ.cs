...
namespace ExpansionKele.Content.Armor.StarArmorA
{
	...
	public class StarHelmetJ : ModItem
	{
    	...
    	return head.type == ModContent.ItemType<StarHelmetJ>() &&
           body.type == ModContent.ItemType<StarBreastplateJ>() &&
           legs.type == ModContent.ItemType<StarLeggingsJ>();
}
