...
namespace ExpansionKele.Content.Armor.StarArmorA
{
	...
	public class StarLeggingsI : ModItem
	{
		...
		public static string setNameOverride="星元护胫I";
    ...
    Recipe recipe = Recipe.Create(ModContent.ItemType<StarLeggingsI>()); // 替换为 GaSniperA 的类型  
    ...
    recipe.AddIngredient(ModContent.ItemType<StarLeggingsH>(), 1);
