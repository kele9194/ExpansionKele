...
namespace ExpansionKele.Content.Armor.StarArmorA
{
	...
	public class StarHelmetI : ModItem
	{
    	...
    	return head.type == ModContent.ItemType<StarHelmetI>() &&
           body.type == ModContent.ItemType<StarBreastplateI>() &&
           legs.type == ModContent.ItemType<StarLeggingsI>();
}
