...
{
    public class ArmorPodwered : ModBuff
    {
        public override string LocalizationCategory => "Buff";
        public static int DefenseReduction = 30;
        public static float MultiplicativeDefenseReduction = 0.7f; // 25% 减少意味着剩下 75%
        ...
        {
            tip = Language.GetText("Mods.ExpansionKele.Buff.ArmorPodwered.Description").Format(DefenseReduction, (1 - MultiplicativeDefenseReduction) * 100, MultiplicativeEnduranceReduction * 100);
        }
