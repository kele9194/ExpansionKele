...
namespace ExpansionKele.Content.Items.Weapons.Ranged
{
	...
	/// </summary>
	public class BurningPaperAirPlane: ModItem
	{
        ...
        public override void SetDefaults() {
			...
			Item.shoot = ModContent.ProjectileType<BurningPaperAirPlaneProjectile>(); // Remember that we must use ProjectileType<>() since it is a modded projectile!
		...
		public override void AddRecipes() {
			CreateRecipe(50)
				.AddIngredient(ItemID.PaperAirplaneA,50)
