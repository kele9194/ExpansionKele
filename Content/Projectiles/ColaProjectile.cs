...
namespace ExpansionKele.Content.Projectiles
{
    public class ColaProjectile : ModProjectile
    {
        ...
        // 使用标准的Texture属性
        public override string Texture => "ExpansionKele/Content/Projectiles/ColaProjectile";
        ...
        public override void Load()
        {
            ...
            _explosionTexture = ModContent.Request<Texture2D>("ExpansionKele/Content/Projectiles/ColaExplosion");
        }
        ...
        {
            // 内部类也使用标准Texture属性
            public override string Texture => "ExpansionKele/Content/Projectiles/ColaExplosion";
