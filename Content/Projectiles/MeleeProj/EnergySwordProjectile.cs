...
namespace ExpansionKele.Content.Projectiles.MeleeProj
{
    public abstract class EnergySwordProjectile : ModProjectile
    {
        ...
        protected virtual float ProjectileWidthHeight { get; } = 16f; // 移除额外放大 - 保持原始比例关系
        // 新增：定义挥舞角度的常量
        protected virtual float SwingAngleMultiplier { get; } = 1f; // 可以调整这个值来改变挥舞角度，例如1.5f会增加50%的角度
        ...
        public override void SetDefaults()
        {
            ...
            Projectile.ownerHitCheckDistance = 300f * 3f; // 放大3倍 - 检查距离也相应放大
        ...
        public override void AI()
        {
            ...
            {
                Dust.NewDustPerfect(dustPosition, DustID.TintableDustLighted, dustVelocity, 100,backDarkColor * Projectile.Opacity, DustSizeMultiplier * Projectile.Opacity);
            }
