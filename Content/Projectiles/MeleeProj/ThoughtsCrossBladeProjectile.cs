...
{
    public class ThoughtsCrossBladeProjectile : ModProjectile
    {
        // 存储剑影纹理的宽度和高度
        ...
        private float baseLineWidth=32;
        // 存储初始方向
        ...
        public override void AI()
        {
            ...
            if (timer == 35)
            {
                ...
                Projectile.NewProjectile(
                    ...
                    Projectile.Center,
                    Vector2.Zero, // 无初始速度
                    ModContent.ProjectileType<ThoughtsCrossBladeMiniProjectile>(),
                    Projectile.damage, // 150%伤害
                    Projectile.knockBack,
                    Projectile.owner,
                    Projectile.ai[0]+45f, // 传递角度
                    Projectile.scale * 0.5f // 传递缩放(一半大小)
                );
            }
...
// ... existing code ...
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            target.AddBuff(ModContent.BuffType<SlicingBuff>(), 60); // 2秒 = 120帧
        }
// ... existing code ...
